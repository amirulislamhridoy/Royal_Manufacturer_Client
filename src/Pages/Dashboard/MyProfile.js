    ...
    <section className='mt-20 mx-10'>
      ...
      <div>
        <div className='flex items-center relative'>
            <button onClick={() => navigate('/dashboard/myProfileEdit')} className='btn btn-ghost btn-sm border-gray-200 border-2 absolute top-0 right-0'>Edit</button>
          <aside className='mx-auto'>
            <img className="max-w-[300px] max-h-[400px] mx-auto rounded" src={data?.img ? data.img : boyCutton} alt="" />
          </aside>
          <aside className='w-6/12'>
            ...
            <div className='flex'>
              ...
              <div>
                ...
                <div className='my-1'>
                  <b>Github : </b>
                  <a className='text-blue-300' href={data?.github} target="_blank">
                    {" "}
                    Github
                  </a>
                </div>
                <div className='my-1'>
                  <b>Portfolio : </b>
                  <a className='text-blue-300' href={data?.portfolio} target="_blank">
                    {" "}
                    Portfolio
                  </a>
                </div>
        ...
        <div class="card bg-base-100 shadow-xl mt-10">
          <div class="card-body">
            ...
            <div className='flex flex-col items-center'>
                <h2 className='text-3xl font-semibold'>{data?.happyClients}</h2>
                <p>Happy Clients</p>
            </div>
            <div className='flex flex-col items-center'>
                <h2 className='text-3xl font-semibold'>{data?.projectCompleted}</h2>
